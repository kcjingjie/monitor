                ...
                function() {
                    ...
                    "function" != typeof JSON.stringify && (e = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, i = {
                        ...
                        if (g = "", h = "", "number" == typeof d)
                            for (e = 0; e < d; e += 1) h += " ";
                        else "string" == typeof d && (h = d); if (j = b, b && "function" != typeof b && ("object" !== (void 0 === b ? "undefined" : f(b)) || "number" != typeof b.length)) throw new Error("JSON.stringify");
                        return c("", {
                            "": a
                        })
        ...
        function(a, b, c) {
            ...
            d = [c(20), c(34), c(57), c(41), c(21), c(1), c(2), c(4), c(8), c(16)], void 0 !== (e = function(a, b, d, e, f, g, h, i, j, k) {
                ...
                function A(a) {
                    var b = "",
                        c = "";
                    return h.flashVersion() || h.isMobile() ? h.flashVersion() && h.flashVersion() < 11.2 ? (b = 'Flash Player版本必须大于11.2, <a href="https://get.adobe.com/cn/flashplayer/" target="_blank">更新Flash Player</a>', c = "102") : h.isMobile() && (h.isRtmp(a[0].file) || h.isFlv(a[0].file)) && (b = "手机上不能播放rtmp或flv格式的视频", c = "111") : (b = '未检测到Flash Player，请前往浏览器网站设置打开Flash播放', c = "101"), {
                        errorMessage: b,
                        errorCode: c
                    }
                }
            ...
            d = [c(15), c(2), c(27), c(1), c(4), c(7), c(26), c(3), c(61)], void 0 !== (e = function(a, b, c, d, e, f, g, h, i) {
                ...
                function l(l, u) {
                    ...
                    this.isSDK = wa, this.itemTracks = Ca, this.video = Fa, d.isObject(u.cast) && u.cast.appid && Fa.setAttribute("disableRemotePlayback", ""), j(pa, Fa), Fa.controls = !0, Fa.controls = !1, Fa.setAttribute("disableRemotePlayback", ""), Fa.setAttribute("x-webkit-airplay", "allow"), Fa.setAttribute("webkit-playsinline", ""), Fa.setAttribute("playsinline", ""), Fa.setAttribute("x5-playsinline", ""), this.stop = function() {
                        ...
                        if (ua)
                            if (a < 0 && (a += T() + U()), 0 === ra && this.trigger(e.JWPLAYER_MEDIA_SEEK, {
                        ...
                        }), Ga.on(e.JWPLAYER_ERROR, M), Ga.tech({
                            IWillNotUseThisInPlugins: !0
                        ...
                        if (!(va === a || a < 0))
                            if (b.isMutipleHls(na)) {
                                va = a, this.trigger(e.JWPLAYER_MEDIA_LEVEL_CHANGED, {
                                    currentQuality: a,
                                    levels: N(na)
                                });
            ...
            d = [c(22), c(2), c(1), c(9), c(171)], void 0 !== (e = function(a, b, c, d, e) {
                return a.extend({
                    ...
                    selectItem: function(a) {
                        ...
                        else b.toggleClass(this.el, "jw-off", 0 === a); if (this.isHDMenu() && this.list && this.list.length >= 2) {
                ...
                return b.extend(p.prototype, c, {
                    ...
                    build: function() {
                        ...
                        !1 !== this._model.get("visualplaylist") && (a = new i("jw-icon-playlist")), this._isMobile || (e = l("jw-icon-volume", this._api.setMute), c = new f("jw-slider-volume", "horizontal"), d = new j(this._model, "jw-icon-volume")), this.elements = {
                            ...
                            left: [this.elements.play, this.elements.prev, this.elements.playlist, this.elements.next, this.elements.elapsed, this.elements.split, this.elements.duration],
            ...
            d = [c(2), c(175), c(1), c(9), c(16)], void 0 !== (e = function(a, b, c, d, e) {
                ...
                return c.extend(f.prototype, {
                    ...
                    getOffset: function(b) {
                        ...
                        if (a.isIE() && a.hasClass(c, "jw-video")) return {
                            x: d,
                            y: e + 40
                        };
